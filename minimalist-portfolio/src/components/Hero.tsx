  ...
  return (
    <section className="w-full min-h-[90vh] flex items-center justify-center pt-24 pb-8">
      ...
      >
        ...
        {/* Center Content */}
        <div className="relative flex-1 flex flex-col items-center justify-center text-center px-4 -mt-4 md:-mt-10 z-10">
          ...
          <div className="mb-6 md:mb-8 flex justify-center">
            ...
            >
              <div className="w-20 h-20 md:w-32 md:h-32 rounded-full overflow-hidden border-4 border-white shadow-soft bg-gray-100">
                <img
              ...
              <div className="absolute -bottom-2 -right-2 bg-white px-3 md:px-4 py-1.5 rounded-full shadow-md border border-brand-secondary/10 flex items-center gap-2">
                <span className="text-[10px] md:text-xs font-bold font-heading text-text-primary">Ibrakhim</span>
                <span className="text-[10px] md:text-xs text-text-secondary">Magomaev</span>
              </div>
            </motion.div>
          </div>
          ...
          {/* Headline */}
          {/* Headline */}
          <h1 className="font-heading font-medium text-4xl md:text-7xl lg:text-8xl tracking-tight text-text-primary leading-[1] max-w-5xl mx-auto">
            ...
            <span className="block mt-2 md:mt-0">Чатботы. Автоматизации.</span>
          </h1>

          <p className="mt-6 md:mt-8 text-base md:text-xl text-text-secondary font-body max-w-2xl px-4">
